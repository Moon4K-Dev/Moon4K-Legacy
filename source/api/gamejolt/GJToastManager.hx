...
class Toast extends Sprite
{
    ...
    public function new(iconPath:String, titleText:String, description:String)
    {
        ...
        */
        ...
        title.setTextFormat(new TextFormat(openfl.utils.Assets.getFont(GJInfo.fontPath).fontName, 24, 0xFFFF00, true));
        title.wordWrap = true;
        title.width = 360;
        ...
        desc.setTextFormat(new TextFormat(openfl.utils.Assets.getFont(GJInfo.fontPath).fontName, 18, 0xFFFFFF));
        desc.wordWrap = true;
        desc.width = 360;
        desc.height = 95;
